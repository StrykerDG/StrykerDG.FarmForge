        ...
        public override void Up()
        {
            ...
            Insert.IntoTable("LogType")
                .Row(new
                {
                    ...
                    Name = "debug",
                    Label = "Debug",
                    Description = "Log generated by a debugging process",
                    Created = now,
                    Modified = now,
                    IsDeleted = false
                })
                .Row(new
                {
                    ...
                    Name = "informational",
                    Label = "Information",
                    Description = "Generic, system related informational log",
                    Created = now,
                    Modified = now,
                    IsDeleted = false
                })
                .Row(new
                {
                    ...
                    Name = "error",
                    Label = "Error",
                    Description = "System related error log",
                    Created = now,
                    Modified = now,
                    IsDeleted = false
                })
                .Row(new
                {
                    ...
                    Name = "observation",
                    Label = "Observation",
                    Description = "An observation about a particular crop",
                    Created = now,
                    Modified = now,
                    IsDeleted = false
                })
                .Row(new
                {
                    ...
                    Name = "input",
                    Label = "Input",
                    Description = "Something was added to the crop, such as fertalizer or water",
                    Created = now,
                    Modified = now,
                    IsDeleted = false
                })
                .Row(new
                {
                    ...
                    Name = "action",
                    Label = "Action",
                    Description = "An action was taken to the crop, such as cultivating or planting",
                    Created = now,
                    Modified = now,
                    IsDeleted = false
                })
                .Row(new
                {
                    ...
                    Name = "harvest",
                    Label = "Harvest",
                    Description = "Crops were harvested",
                    Created = now,
                    Modified = now,
                    IsDeleted = false
                });
